...
function generate() {
  ...
  const lines = [
    ...
    '  <a href="/downloads/cove-更新日志.pdf" download style="display:inline-block;padding:10px 24px;background:#2563eb;color:#fff;border-radius:8px;text-decoration:none;font-weight:500;">',
    '    ⬇ 下载 PDF 版本',
    '  </a>',
    '</div>',
    '',
